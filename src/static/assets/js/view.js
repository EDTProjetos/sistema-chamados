document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderizarChamados(chamados) {
        ...
        chamados.forEach(chamado => {
            ...
            const imagemCell = fields.ImagemAnexo && fields.ImagemAnexo.trim() !== '' 
                ? `<a href="${fields.ImagemAnexo}" target="_blank" class="text-teal-600 hover:text-teal-800 transition-colors">
            ...
            tr.innerHTML = `
                ...
                <td class="px-6 py-4 text-center">${imagemCell}</td>
            `;
